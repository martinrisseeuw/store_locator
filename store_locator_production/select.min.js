! function(t, e) {
    ...
    document.addEventListener("keypress", function(t) {
        ...
        var e = r();
        if (e)
            if ([m, O, v].indexOf(t.keyCode) >= 0 && t.preventDefault(), e.isOpen()) switch (t.keyCode) {
                case m:
                case O:
    ...
    var C = function(o) {
        ...
        return n(r, o), s(r, [{
                ...
                if (n) {
                    ...
                    var i = function() {
                            if (p(t.drop, "tether-abutted-left") || p(t.drop, "tether-abutted-bottom")) {
                                var e = d(t.drop),
                                    i = d(n),
                                    o = e.top - (i.top + i.height);
                                t.drop.style.top = (parseFloat(t.drop.style.top) || 0) + o + "px"
                            }
                        },
                        o = this.options.alignToHighlighted,
                        r = this.content,
                        s = r.scrollHeight,
                        a = r.clientHeight;
            ...
            value: function(t) {
                ...
                e && u(e, "select-option-highlight"), h(t, "select-option-highlight"), this.trigger("highlight", {
                    option: t
                })
            }
        }, {
            ...
            value: function(t) {
                ...
                var n = this.drop.querySelectorAll(".select-option"),
                    i = Array.prototype.indexOf.call(n, e);
            ...
            value: function() {
                ...
                t.initEvent("change", !0, !1), this.select.dispatchEvent(t), this.trigger("change", {
